...
const equipmentSeeds: EquipmentSeed[] = [
  ...
  ['dildo', 'Dildo', 'Dildo og anal', 'free'],
  ['sleeve', 'Sleeve', 'Pik og milking', 'solo'],
  ['plug', 'Plug', 'Dildo og anal', 'solo'],
  ['strap_on', 'Strap-on', 'Dildo og anal', 'solo'],
  ...
  ['chastity', 'Kyskhedsbur', 'Bondage light', 'solo', 'kyskhedsbur som aftalt voksenleg; ingen rigtig lås ude i byen'],
  ...
  ['slim_plug', 'Tynd plug', 'Dildo og anal', 'solo'],
  ['thick_plug', 'Tyk plug', 'Dildo og anal', 'solo'],
  ['tail_plug', 'Hale-plug', 'Dildo og anal', 'solo'],
  ...
  ['anal_beads', 'Anal kugler', 'Dildo og anal', 'plus'],
  ['prostate', 'Prostatamassager', 'Dildo og anal', 'plus'],
  ['double_dildo', 'Dobbelt dildo', 'Dildo og anal', 'plus'],
  ['nipple_clamps', 'Brystklemme', 'Bryster og hud', 'plus'],
  ['suction_cups', 'Sugekopper', 'Bryster og hud', 'plus'],
  ['ice', 'Is', 'Bryster og hud', 'plus'],
  ['feather', 'Fjer / kilder', 'Bryster og hud', 'plus'],
  ['massage_oil', 'Massageolie', 'Bryster og hud', 'plus'],
  ['wax_low', 'Lavtemperatur-voks', 'Bryster og hud', 'plus', 'mærkevare-lavtemperatur-voks; ingen ild-guide'],
...
export const DEFAULT_CONTENT_CATALOG: ContentCatalog = {
  ...
  equipment,
  fetishes: [
    { id: 'edge', title: 'Edge', blurb: 'Op, hold, ned. Kernen.', prompt: 'Fokusér på kontrolleret opbygning, stop og gentagelser.', group: 'Kerne', enabled: true, free: true, minimumPlan: 'free', order: 0 },
    { id: 'power', title: 'Power', blurb: 'D/s, protocol, service. Voksne roller.', prompt: 'Fokusér på tydelige voksne roller, aftalte regler og service.', group: 'Kerne', enabled: true, free: true, minimumPlan: 'free', order: 1 },
    { id: 'aftercare', title: 'Aftercare', blurb: 'Scene ovre. Vand. Varm stemme.', prompt: 'Fokusér på ro, omsorg, nedtrapning og tryghed.', group: 'Kerne', enabled: true, free: true, minimumPlan: 'free', order: 2 },
    { id: 'cei', title: 'CEI', blurb: 'Efter finish: slikke / sluge. Kun voksne.', prompt: 'Fokusér kun på det valgte CEI-tema mellem samtykkende voksne.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 3 },
    { id: 'milking', title: 'Milking', blurb: 'Maskine, sleeve, e-stim som legetøj.', prompt: 'Fokusér på det valgte milking-tema som voksen fiktion og undgå farlige instruktioner.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 4 },
    { id: 'joi', title: 'JOI', blurb: 'Hånd og tempo styret med ord.', prompt: 'Fokusér på verbal, voksen og samtykkende instruktion inden for brugerens grænser.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 5 },
    { id: 'chastity', title: 'Chastity', blurb: 'Timer og deny. Ingen rigtig lås ude i byen.', prompt: 'Fokusér på denial, timer og aftalt kontrol uden virkelige risikable situationer.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 6 },
    { id: 'humiliation', title: 'Humiliation', blurb: 'Nedladende register. Default slået fra.', prompt: 'Brug kun den valgte grad af voksen humiliation og respekter forbuddet mod øgenavne.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 7 },
    { id: 'femdom', title: 'FemDom', blurb: 'Hun styrer. Pegging kun som tale.', prompt: 'Fokusér på en voksen femdom-dynamik med tydelig kontrol og samtykke.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 8 },
    { id: 'anal', title: 'Anal / prostate', blurb: 'Play og milking som voksen fiktion.', prompt: 'Hold dig til det valgte voksne anal/prostate-tema uden farlige eller medicinske instruktioner.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 9 },
    { id: 'worship', title: 'Worship', blurb: 'Krop, støvler, service. Ingen race play.', prompt: 'Fokusér på voksen worship, service og beundring.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 10 },
    { id: 'roleskin', title: 'Role skin', blurb: 'Maid, military, voksen petplay. Ikke schoolgirl.', prompt: 'Brug kun tydeligt voksne rolletemaer og aldrig barnlige eller mindreårige roller.', group: 'Ekstra', enabled: true, free: false, minimumPlan: 'plus', order: 11 },
  ],
}
